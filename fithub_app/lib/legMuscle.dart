...
class LegMusclePage extends StatefulWidget {
  @override
  _LegMusclePageState createState() => _LegMusclePageState();
}

class _LegMusclePageState extends State<LegMusclePage> {
  ...
  Future<void> fetchExercises() async {
    final response = await http.get(
      Uri.parse('https://exercisedb.p.rapidapi.com/exercises/target/quads'),
      headers: {
        'X-RapidAPI-Key':
